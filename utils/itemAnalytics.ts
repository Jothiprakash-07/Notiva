...
export function calculateAnalytics(items: ReminderItem[], period: AnalyticsPeriod, now = new Date(), weekStartsOn: 0 | 1 = 1) {
  ...
  // Weekly activity always uses all stored items, including items scheduled in
